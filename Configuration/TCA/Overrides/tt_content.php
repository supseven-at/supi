...
(function ($extKey, $table, $type): void {
    ...
    ExtensionManagementUtility::addTcaSelectItem(
        ...
        'CType',
        [
            'label' => $ll . $table . '.tx_supi_meta.title',
            'value' => 'tx_supi_meta',
            'icon'  => 'supi',
        ]
    );
    ...
    $showitem = [
        ...
        '--palette--;LLL:EXT:frontend/Resources/Private/Language/locallang_ttc.xlf:palette.general;general',
        '--palette--;LLL:EXT:frontend/Resources/Private/Language/locallang_ttc.xlf:palette.headers;headers',
        'bodytext;' . $ll . $table . '.field.bodytext.tx_supi_meta.title',
        '--div--;LLL:EXT:frontend/Resources/Private/Language/locallang_ttc.xlf:tabs.appearance',
        '--palette--;LLL:EXT:frontend/Resources/Private/Language/locallang_ttc.xlf:palette.frames;frames',
        '--palette--;LLL:EXT:frontend/Resources/Private/Language/locallang_ttc.xlf:palette.appearanceLinks;appearanceLinks',
        '--div--;LLL:EXT:core/Resources/Private/Language/Form/locallang_tabs.xlf:language',
    ...
    $GLOBALS['TCA'][$table]['types']['tx_supi_meta'] = [
        'showitem'         => implode(',', $showitem),
        'columnsOverrides' => [
            'bodytext' => [
                'description' => $ll . $table . '.field.bodytext.tx_supi_meta.description',
                'config'      => [
                    'eval' => 'required,trim',
                ],
            ],
